...
router.get(
  ...
  verifyAuth, verifyRoles([1]), adminRateLimit, requirePermission('services.view'),
  ctrl.listOfferings
);
router.post(
  "/admin/provider-catalog/offerings",
  verifyAuth, verifyRoles([1]), adminRateLimit, requirePermission('services.offering.create'),
  ctrl.createOffering
);
...
router.get(
  ...
  verifyAuth, verifyRoles([1]), adminRateLimit, requirePermission('services.details.view'),
  ctrl.getSpecificService
);
router.post(
  "/admin/provider-catalog/specific-services/:serviceOptionId/banner",
  verifyAuth, verifyRoles([1]), adminRateLimit, requirePermission('services.specific.edit'),
...
router.patch(
  ...
  verifyAuth, verifyRoles([1]), adminRateLimit, requirePermission('services.specific.archive'),
  ctrl.updateSpecificServiceStatus
);
router.post(
  "/admin/provider-catalog/specific-services/:serviceOptionId/addons",
  verifyAuth, verifyRoles([1]), adminRateLimit, requirePermission('services.addon.create'),
  ctrl.createAddon
);
...
router.patch(
  ...
  verifyAuth, verifyRoles([1]), adminRateLimit, requirePermission('services.addon.edit'),
  ctrl.updateAddon
);
router.patch(
  "/admin/provider-catalog/addons/:addonOptionId/status",
  verifyAuth, verifyRoles([1]), adminRateLimit, requirePermission('services.addon.archive'),
...
router.patch(
  ...
  verifyAuth, verifyRoles([1]), adminRateLimit, requirePermission('services.mapping.edit'),
  ctrl.updateOfferingMapping
);
router.delete(
  "/admin/provider-catalog/mappings/:mappingId",
  verifyAuth, verifyRoles([1]), adminRateLimit, requirePermission('services.mapping.archive'),
...
router.patch(
  "/admin/provider-catalog/offerings/:offeringId",
  verifyAuth, verifyRoles([1]), adminRateLimit, requirePermission('services.offering.edit'),
  ctrl.updateOffering
);
router.put(
...
router.patch(
  ...
  verifyAuth, verifyRoles([1]), adminRateLimit, requirePermission('services.offering.archive'),
  ctrl.updateOfferingStatus
);
router.post(
  "/admin/provider-catalog/offerings/:offeringId/mappings",
  verifyAuth, verifyRoles([1]), adminRateLimit, requirePermission('services.mapping.create'),
  ctrl.createOfferingMapping
);
router.post(
  "/admin/provider-catalog/offerings/:offeringId/publish-preview",
  verifyAuth, verifyRoles([1]), adminRateLimit, requirePermission('services.compatibility_preview.run'),
  ctrl.publishPreviewOffering
);
router.post(
  "/admin/provider-catalog/offerings/:offeringId/publish",
  verifyAuth, verifyRoles([1]), adminRateLimit, requirePermission('services.publish'),
...
router.post(
  "/admin/provider-catalog/offerings/:offeringId/specific-services",
  verifyAuth, verifyRoles([1]), adminRateLimit, requirePermission('services.specific.create'),

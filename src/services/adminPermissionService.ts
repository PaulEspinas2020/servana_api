...
const PERMISSION_SEEDS: PermissionSeed[] = [
  ...
  { key: 'providers.services.assign', module: 'providers', group_label: 'Provider Registry', label: 'Assign Provider Services', description: 'Audited admin override of the normal service-application flow', action_type: 'override', risk_level: 'critical', requires: ['providers.active_services.view'], is_dangerous: true, display_order: 485 },
  ...
  { key: 'providers.availability.force_offline', module: 'providers', group_label: 'Provider Registry', label: 'Force Provider Offline', description: 'Immediately set a provider to offline regardless of their chosen status. Requires a reason. Audited.', action_type: 'override', risk_level: 'critical', requires: ['providers.profile.view'], is_dangerous: true, display_order: 495 },
  ...
  { key: 'providers.services.remove', module: 'providers', group_label: 'Provider Registry', label: 'Remove Provider Service Association', description: 'Remove an approved service from a provider without deleting the global catalog entry', action_type: 'edit', risk_level: 'high', requires: ['providers.active_services.view'], display_order: 545 },
  ...
  { key: 'reviews.moderation.view', module: 'reviews', group_label: 'Review Moderation', label: 'View Review Cases', description: 'View provider review reports and appeals.', action_type: 'view', risk_level: 'medium', requires: ['providers.profile.view'], display_order: 570 },
  { key: 'reviews.moderation.decide', module: 'reviews', group_label: 'Review Moderation', label: 'Decide Review Cases', description: 'Apply review moderation decisions with provider-safe reasons.', action_type: 'decision', risk_level: 'high', requires: ['reviews.moderation.view'], display_order: 580 },
  ...
  { key: 'communications.support_conversations.send', module: 'communications', group_label: 'Communications / Notifications', label: 'Send Support Messages', description: 'Reply to booking conversations shared with mobile users', action_type: 'edit', risk_level: 'medium', requires: ['communications.support_conversations.view'], display_order: 2335 },
  { key: 'communications.message_reports.view', module: 'communications', group_label: 'Communications / Notifications', label: 'View Message Reports', description: 'View reported chat messages and moderation context', action_type: 'view', risk_level: 'medium', requires: ['communications.support_conversations.view'], display_order: 2336 },
  { key: 'communications.message_reports.resolve', module: 'communications', group_label: 'Communications / Notifications', label: 'Resolve Message Reports', description: 'Dismiss, warn, or redact reported chat messages', action_type: 'edit', risk_level: 'high', requires: ['communications.message_reports.view'], display_order: 2337 },
  ...
  // Provider support case operations
  { key: 'support.cases.view', module: 'support', group_label: 'Provider Support Cases', label: 'View Provider Support Cases', description: 'View the provider-safe case record, queue state, and SLA metadata', action_type: 'view', risk_level: 'medium', requires: [], display_order: 2360 },
  { key: 'support.cases.reply', module: 'support', group_label: 'Provider Support Cases', label: 'Reply to Provider Cases', description: 'Send provider-visible case messages and information requests', action_type: 'edit', risk_level: 'medium', requires: ['support.cases.view'], display_order: 2361 },
  { key: 'support.cases.internal_notes', module: 'support', group_label: 'Provider Support Cases', label: 'Add Internal Case Notes', description: 'Create restricted notes that are never returned to providers', action_type: 'sensitive', risk_level: 'high', requires: ['support.cases.view'], display_order: 2362 },
  { key: 'support.cases.transition', module: 'support', group_label: 'Provider Support Cases', label: 'Transition Provider Cases', description: 'Move cases through controlled public and internal states', action_type: 'edit', risk_level: 'high', requires: ['support.cases.view'], display_order: 2363 },
  { key: 'support.cases.escalate', module: 'support', group_label: 'Provider Support Cases', label: 'Escalate Provider Cases', description: 'Escalate a case to another authorized queue while preserving history', action_type: 'override', risk_level: 'high', requires: ['support.cases.view'], display_order: 2364 },
  { key: 'support.cases.resolve', module: 'support', group_label: 'Provider Support Cases', label: 'Resolve Provider Cases', description: 'Record a provider-visible resolution without bypassing source-domain authorization', action_type: 'approve', risk_level: 'critical', requires: ['support.cases.transition'], is_dangerous: true, display_order: 2365 },
  { key: 'support.appeals.decide', module: 'support', group_label: 'Provider Support Cases', label: 'Decide Provider Appeals', description: 'Uphold a resolution or reopen a case for independent review', action_type: 'approve', risk_level: 'critical', requires: ['support.cases.resolve'], is_dangerous: true, display_order: 2366 },
  { key: 'support.evidence.sensitive.view', module: 'support', group_label: 'Provider Support Cases', label: 'View Sensitive Case Evidence', description: 'Generate a short-lived private preview URL for case evidence', action_type: 'sensitive', risk_level: 'critical', requires: ['support.cases.view'], is_dangerous: true, display_order: 2367 },
  { key: 'support.sla.manage', module: 'support', group_label: 'Provider Support Cases', label: 'Run Support SLA Escalation', description: 'Apply the deterministic breach and priority policy to overdue cases', action_type: 'system', risk_level: 'high', requires: ['support.cases.escalate'], display_order: 2368 },

...
|---|---:|---|
| `ALIAS_TEMPORARILY` | 90 | A canonical v1 successor exists. Kept until every caller migrates; traffic is counted. |
...
| `KEEP` | 404 | Not a duplicate of anything canonical. Untouched by this command. |

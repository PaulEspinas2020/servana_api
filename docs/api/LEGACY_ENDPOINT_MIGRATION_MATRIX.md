...
| `POST` | `/api/admin/finance/reconciliation/run` | `src/routes/adminFinance.routes.ts:45` |
| `POST` | `/api/admin/finance/reconciliation/exceptions/:exceptionId/resolve` | `src/routes/adminFinance.routes.ts:47` |
| `POST` | `/api/admin/finance/reconciliation/exceptions/:exceptionId/ignore` | `src/routes/adminFinance.routes.ts:48` |

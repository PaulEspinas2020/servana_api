 ...
 * Run: npx jest tests/admin-dashboard.test.js
 */
...
function buildQueue(counts) {
  ...
  return q.sort((a, b) => {
    const sa = severityOrder[a.severity] !== undefined ? severityOrder[a.severity] : 4;
    const sb = severityOrder[b.severity] !== undefined ? severityOrder[b.severity] : 4;
    return sa - sb;
  });
}
